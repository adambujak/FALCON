...
void nRF24L01_set_address(nRF24L01_t *instance, const nRF24L01_address_t address, const uint8_t *addr)
{
  switch(address)
  {
    ...
    case NRF24L01_PIPE0:
    case NRF24L01_PIPE1:
      nRF24L01_write_multibyte_reg(instance, NRF24L01_W_REGISTER + NRF24L01_RX_ADDR_P0 + (uint8_t) address, addr, nRF24L01_get_address_width(instance));
      break;
    case NRF24L01_PIPE2:
    case NRF24L01_PIPE3:
    case NRF24L01_PIPE4:
...
{
  return ((nRF24L01_read_reg(instance, NRF24L01_FIFO_STATUS) & ((1U<<NRF24L01_TX_FIFO_FULL)|(1U<<NRF24L01_TX_EMPTY))) >> 4);
}
