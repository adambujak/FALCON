...
/* MOTORS */
#define FLN_MOTOR_TIMER                 TIM4
#define FLN_MOTOR_TIMER_CLK_ENABLE()    __HAL_RCC_TIM4_CLK_ENABLE()
#define FLN_MOTOR_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOD_CLK_ENABLE();

#define FLN_MOTOR_GPIO_PORT_CHANNEL1    GPIOD
#define FLN_MOTOR_GPIO_PORT_CHANNEL2    GPIOD
#define FLN_MOTOR_GPIO_PORT_CHANNEL3    GPIOD
#define FLN_MOTOR_GPIO_PORT_CHANNEL4    GPIOD
#define FLN_MOTOR_GPIO_PIN_CHANNEL1     GPIO_PIN_12
#define FLN_MOTOR_GPIO_PIN_CHANNEL2     GPIO_PIN_13
#define FLN_MOTOR_GPIO_PIN_CHANNEL3     GPIO_PIN_14
#define FLN_MOTOR_GPIO_PIN_CHANNEL4     GPIO_PIN_15
#define FLN_MOTOR_GPIO_AF_CHANNEL1      GPIO_AF2_TIM4
#define FLN_MOTOR_GPIO_AF_CHANNEL2      GPIO_AF2_TIM4
#define FLN_MOTOR_GPIO_AF_CHANNEL3      GPIO_AF2_TIM4
#define FLN_MOTOR_GPIO_AF_CHANNEL4      GPIO_AF2_TIM4
